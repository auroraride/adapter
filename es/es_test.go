...
func TestEs(t *testing.T) {
	instance, err := Create("b19FdHpJOEI1VEVyeZVjOUs1WUM6MHIxUktUTGpROS1VaGdzZXRMQkVUQQ==", "development-electric-consumption-cabinet-", []string{"http://172.16.1.108:9200"})
	require.NoError(t, err)
	instance.CreateDocument(&Document{
		Serial:    "x-test",
		Value:     198.00,
		Timestamp: time.Now(),
	})
