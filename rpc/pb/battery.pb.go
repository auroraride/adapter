...
type OverlappingRequest struct {
	...
	Sn        string                 `protobuf:"bytes,1,opt,name=sn,proto3" json:"sn,omitempty"`                // 电池编码
	Start     *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=start,proto3" json:"start,omitempty"`          // 起始时间
	End       *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=end,proto3" json:"end,omitempty"`              // 结束时间
	Tolerance uint64                 `protobuf:"varint,4,opt,name=tolerance,proto3" json:"tolerance,omitempty"` // 时间窗口大小（秒）
	Distance  float64                `protobuf:"fixed64,5,opt,name=distance,proto3" json:"distance,omitempty"`  // 距离阈值（米）
}

func (x *OverlappingRequest) Reset() {
	*x = OverlappingRequest{}
	mi := &file_battery_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OverlappingRequest) Descriptor() ([]byte, []int) {
	return file_battery_proto_rawDescGZIP(), []int{19}
}

func (x *OverlappingRequest) GetSn() string {
	if x != nil {
		return x.Sn
	}
	return ""
...
func (x *OverlappingRequest) GetStart() *timestamppb.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *OverlappingRequest) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *OverlappingRequest) GetTolerance() uint64 {
	if x != nil {
		return x.Tolerance
	}
	return 0
...
func (x *OverlappingRequest) GetDistance() float64 {
	if x != nil {
		return x.Distance
	}
	return 0
...
type OverlappingItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CandidateSn        string  `protobuf:"bytes,1,opt,name=candidateSn,proto3" json:"candidateSn,omitempty"`                 // 候选电池编码
	CandidateTs        string  `protobuf:"bytes,2,opt,name=candidateTs,proto3" json:"candidateTs,omitempty"`                 // 候选电池出现时间
	CandidateLatitude  float64 `protobuf:"fixed64,3,opt,name=candidateLatitude,proto3" json:"candidateLatitude,omitempty"`   // 候选电池纬度
	CandidateLongitude float64 `protobuf:"fixed64,4,opt,name=candidateLongitude,proto3" json:"candidateLongitude,omitempty"` // 候选电池经度
	Distance           float64 `protobuf:"fixed64,5,opt,name=distance,proto3" json:"distance,omitempty"`                     // 候选电池与目标电池的距离
	Ts                 string  `protobuf:"bytes,6,opt,name=ts,proto3" json:"ts,omitempty"`                                   // 目标电池出现时间
	Latitude           float64 `protobuf:"fixed64,7,opt,name=latitude,proto3" json:"latitude,omitempty"`                     // 目标电池纬度
	Longitude          float64 `protobuf:"fixed64,8,opt,name=longitude,proto3" json:"longitude,omitempty"`                   // 目标电池经度
}

func (x *OverlappingItem) Reset() {
	*x = OverlappingItem{}
	mi := &file_battery_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OverlappingItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OverlappingItem) ProtoMessage() {}

func (x *OverlappingItem) ProtoReflect() protoreflect.Message {
	mi := &file_battery_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OverlappingItem.ProtoReflect.Descriptor instead.
func (*OverlappingItem) Descriptor() ([]byte, []int) {
	return file_battery_proto_rawDescGZIP(), []int{20}
}

func (x *OverlappingItem) GetCandidateSn() string {
	if x != nil {
		return x.CandidateSn
	}
	return ""
}

func (x *OverlappingItem) GetCandidateTs() string {
	if x != nil {
		return x.CandidateTs
	}
	return ""
}

func (x *OverlappingItem) GetCandidateLatitude() float64 {
	if x != nil {
		return x.CandidateLatitude
	}
	return 0
}

func (x *OverlappingItem) GetCandidateLongitude() float64 {
	if x != nil {
		return x.CandidateLongitude
	}
	return 0
}

func (x *OverlappingItem) GetDistance() float64 {
	if x != nil {
		return x.Distance
	}
	return 0
...
func (x *OverlappingItem) GetTs() string {
	if x != nil {
		return x.Ts
	}
	return ""
...
func (x *OverlappingItem) GetLatitude() float64 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *OverlappingItem) GetLongitude() float64 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
type OverlappingResponse struct {
	...
	Items []*OverlappingItem `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}

func (x *OverlappingResponse) Reset() {
	*x = OverlappingResponse{}
	mi := &file_battery_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OverlappingResponse) Descriptor() ([]byte, []int) {
	return file_battery_proto_rawDescGZIP(), []int{21}
}

func (x *OverlappingResponse) GetItems() []*OverlappingItem {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_battery_proto_rawDesc = []byte{
	...
	,
	...
	0x12, 0x0e, 0x0a, 0x02, 0x74, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x73,
	...
	0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0x40, 0x0a, 0x13, 0x4f, 0x76,
	0x65, 0x72, 0x6c, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x29, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61, 0x70, 0x70, 0x69, 0x6e,
	0x67, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x2a, 0xd5, 0x03, 0x0a,
	...
	0x67, 0x68, 0x10, 0x10, 0x32, 0x92, 0x04, 0x0a, 0x07, 0x42, 0x61, 0x74, 0x74, 0x65, 0x72, 0x79,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x0b, 0x4f, 0x76, 0x65,
	0x72, 0x6c, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x12, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x76,
	0x65, 0x72, 0x6c, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x4f, 0x76, 0x65, 0x72, 0x6c, 0x61, 0x70, 0x70, 0x69, 0x6e,
	0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74,
...
var file_battery_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_battery_proto_goTypes = []any{
	...
	(*OverlappingRequest)(nil),           // 22: pb.OverlappingRequest
	(*OverlappingItem)(nil),              // 23: pb.OverlappingItem
	(*OverlappingResponse)(nil),          // 24: pb.OverlappingResponse
	nil,                                  // 25: pb.BatteryBatchResponse.ItemsEntry
	...
	(*timestamppb.Timestamp)(nil),        // 29: timestamppb.Timestamp
	(*PaginationRequest)(nil),            // 30: pb.PaginationRequest
	(*PaginationResponse)(nil),           // 31: pb.PaginationResponse
}
var file_battery_proto_depIdxs = []int32{
	26, // 0: pb.BatteryItem.soft_version:type_name -> google.protobuf.UInt32Value
	26, // 1: pb.BatteryItem.hard_version:type_name -> google.protobuf.UInt32Value
	26, // 2: pb.BatteryItem.soft_4g_version:type_name -> google.protobuf.UInt32Value
	26, // 3: pb.BatteryItem.hard_4g_version:type_name -> google.protobuf.UInt32Value
	27, // 4: pb.BatteryItem.sn_4g:type_name -> google.protobuf.UInt64Value
	28, // 5: pb.BatteryItem.iccid:type_name -> google.protobuf.StringValue
	26, // 6: pb.BatteryItem.soc:type_name -> google.protobuf.UInt32Value
	5,  // 7: pb.BatteryItem.heartbeats:type_name -> pb.BatteryHeartbeat
	29, // 8: pb.BatteryHeartbeat.created_at:type_name -> timestamppb.Timestamp
	4,  // 9: pb.BatteryHeartbeat.battery:type_name -> pb.BatteryItem
	3,  // 10: pb.BatteryBatchRequest.cycles:type_name -> pb.BatteryCycles
	25, // 11: pb.BatteryBatchResponse.items:type_name -> pb.BatteryBatchResponse.ItemsEntry
	...
	30, // 14: pb.BatteryFaultListRequest.pagination:type_name -> pb.PaginationRequest
	29, // 15: pb.BatteryFaultListRequest.begin_at:type_name -> timestamppb.Timestamp
	29, // 16: pb.BatteryFaultListRequest.end_at:type_name -> timestamppb.Timestamp
	0,  // 17: pb.BatteryFaultListRequest.fault:type_name -> pb.BatteryFaultType
	29, // 18: pb.BatteryFaultListRequest.start:type_name -> timestamppb.Timestamp
	29, // 19: pb.BatteryFaultListRequest.stop:type_name -> timestamppb.Timestamp
	0,  // 20: pb.BatteryFault.fault:type_name -> pb.BatteryFaultType
	29, // 21: pb.BatteryFault.begin_at:type_name -> timestamppb.Timestamp
	29, // 22: pb.BatteryFault.end_at:type_name -> timestamppb.Timestamp
	31, // 23: pb.BatteryFaultListResponse.pagination:type_name -> pb.PaginationResponse
	13, // 24: pb.BatteryFaultListResponse.items:type_name -> pb.BatteryFault
	29, // 25: pb.BatteryPositionRequest.start:type_name -> timestamppb.Timestamp
	29, // 26: pb.BatteryPositionRequest.end:type_name -> timestamppb.Timestamp
	29, // 27: pb.BatteryPosition.at:type_name -> timestamppb.Timestamp
	29, // 28: pb.BatteryStationary.start_at:type_name -> timestamppb.Timestamp
	29, // 29: pb.BatteryStationary.end_at:type_name -> timestamppb.Timestamp
	29, // 30: pb.BatteryPositionResponse.start:type_name -> timestamppb.Timestamp
	29, // 31: pb.BatteryPositionResponse.end:type_name -> timestamppb.Timestamp
	...
	29, // 37: pb.OverlappingRequest.start:type_name -> timestamppb.Timestamp
	29, // 38: pb.OverlappingRequest.end:type_name -> timestamppb.Timestamp
	23, // 39: pb.OverlappingResponse.items:type_name -> pb.OverlappingItem
	4,  // 40: pb.BatteryBatchResponse.ItemsEntry.value:type_name -> pb.BatteryItem
	7,  // 41: pb.Battery.Batch:input_type -> pb.BatteryBatchRequest
	6,  // 42: pb.Battery.Sample:input_type -> pb.BatterySnRequest
	12, // 43: pb.Battery.FaultList:input_type -> pb.BatteryFaultListRequest
	6,  // 44: pb.Battery.FaultOverview:input_type -> pb.BatterySnRequest
	6,  // 45: pb.Battery.Statistics:input_type -> pb.BatterySnRequest
	16, // 46: pb.Battery.Position:input_type -> pb.BatteryPositionRequest
	20, // 47: pb.Battery.List:input_type -> pb.BatteryListRequest
	22, // 48: pb.Battery.Overlapping:input_type -> pb.OverlappingRequest
	8,  // 49: pb.Battery.Batch:output_type -> pb.BatteryBatchResponse
	9,  // 50: pb.Battery.Sample:output_type -> pb.BatterySampleResponse
	14, // 51: pb.Battery.FaultList:output_type -> pb.BatteryFaultListResponse
	11, // 52: pb.Battery.FaultOverview:output_type -> pb.BatteryFaultOverviewResponse
	15, // 53: pb.Battery.Statistics:output_type -> pb.BatteryStatisticsResponse
	19, // 54: pb.Battery.Position:output_type -> pb.BatteryPositionResponse
	21, // 55: pb.Battery.List:output_type -> pb.BatteryListResponse
	24, // 56: pb.Battery.Overlapping:output_type -> pb.OverlappingResponse
