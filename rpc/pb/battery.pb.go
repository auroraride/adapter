...
var file_battery_proto_goTypes = []any{
	...
	(*BatteryCycles)(nil),                // 1: pb.BatteryCycles
	(*BatteryItem)(nil),                  // 2: pb.BatteryItem
	(*BatteryHeartbeat)(nil),             // 3: pb.BatteryHeartbeat
	(*BatterySnRequest)(nil),             // 4: pb.BatterySnRequest
	(*BatteryBatchRequest)(nil),          // 5: pb.BatteryBatchRequest
	(*BatteryBatchResponse)(nil),         // 6: pb.BatteryBatchResponse
	(*BatterySampleResponse)(nil),        // 7: pb.BatterySampleResponse
...
var file_battery_proto_depIdxs = []int32{
	...
	3,  // 7: pb.BatteryItem.heartbeats:type_name -> pb.BatteryHeartbeat
	22, // 8: pb.BatteryHeartbeat.created_at:type_name -> timestamppb.Timestamp
	2,  // 9: pb.BatteryHeartbeat.battery:type_name -> pb.BatteryItem
	1,  // 10: pb.BatteryBatchRequest.cycles:type_name -> pb.BatteryCycles
	18, // 11: pb.BatteryBatchResponse.items:type_name -> pb.BatteryBatchResponse.ItemsEntry
	...
	23, // 14: pb.BatteryFaultListRequest.pagination:type_name -> pb.PaginationRequest
	22, // 15: pb.BatteryFaultListRequest.begin_at:type_name -> timestamppb.Timestamp
	22, // 16: pb.BatteryFaultListRequest.end_at:type_name -> timestamppb.Timestamp
	...
	22, // 19: pb.BatteryFault.begin_at:type_name -> timestamppb.Timestamp
	22, // 20: pb.BatteryFault.end_at:type_name -> timestamppb.Timestamp
	24, // 21: pb.BatteryFaultListResponse.pagination:type_name -> pb.PaginationResponse
	11, // 22: pb.BatteryFaultListResponse.items:type_name -> pb.BatteryFault
	22, // 23: pb.BatteryPositionRequest.start:type_name -> timestamppb.Timestamp
	22, // 24: pb.BatteryPositionRequest.end:type_name -> timestamppb.Timestamp
	22, // 25: pb.BatteryPosition.at:type_name -> timestamppb.Timestamp
	22, // 26: pb.BatteryStationary.start_at:type_name -> timestamppb.Timestamp
	22, // 27: pb.BatteryStationary.end_at:type_name -> timestamppb.Timestamp
	22, // 28: pb.BatteryPositionResponse.start:type_name -> timestamppb.Timestamp
	22, // 29: pb.BatteryPositionResponse.end:type_name -> timestamppb.Timestamp
	...
	2,  // 32: pb.BatteryBatchResponse.ItemsEntry.value:type_name -> pb.BatteryItem
	5,  // 33: pb.Battery.Batch:input_type -> pb.BatteryBatchRequest
	4,  // 34: pb.Battery.Sample:input_type -> pb.BatterySnRequest
	10, // 35: pb.Battery.FaultList:input_type -> pb.BatteryFaultListRequest
	4,  // 36: pb.Battery.FaultOverview:input_type -> pb.BatterySnRequest
	4,  // 37: pb.Battery.Statistics:input_type -> pb.BatterySnRequest
	14, // 38: pb.Battery.Position:input_type -> pb.BatteryPositionRequest
	6,  // 39: pb.Battery.Batch:output_type -> pb.BatteryBatchResponse
	7,  // 40: pb.Battery.Sample:output_type -> pb.BatterySampleResponse
	12, // 41: pb.Battery.FaultList:output_type -> pb.BatteryFaultListResponse
	9,  // 42: pb.Battery.FaultOverview:output_type -> pb.BatteryFaultOverviewResponse
	13, // 43: pb.Battery.Statistics:output_type -> pb.BatteryStatisticsResponse
	17, // 44: pb.Battery.Position:output_type -> pb.BatteryPositionResponse
