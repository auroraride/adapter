...
const (
	...
	Battery_List_FullMethodName          = "/pb.Battery/List"
	Battery_Overlapping_FullMethodName   = "/pb.Battery/Overlapping"
)
...
type BatteryClient interface {
	...
	List(ctx context.Context, in *BatteryListRequest, opts ...grpc.CallOption) (*BatteryListResponse, error)
	Overlapping(ctx context.Context, in *OverlappingRequest, opts ...grpc.CallOption) (*OverlappingResponse, error)
}
...
func (c *batteryClient) Batch(ctx context.Context, in *BatteryBatchRequest, opts ...grpc.CallOption) (*BatteryBatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_Batch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) Sample(ctx context.Context, in *BatterySnRequest, opts ...grpc.CallOption) (*BatterySampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_Sample_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) FaultList(ctx context.Context, in *BatteryFaultListRequest, opts ...grpc.CallOption) (*BatteryFaultListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_FaultList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) FaultOverview(ctx context.Context, in *BatterySnRequest, opts ...grpc.CallOption) (*BatteryFaultOverviewResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_FaultOverview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) Statistics(ctx context.Context, in *BatterySnRequest, opts ...grpc.CallOption) (*BatteryStatisticsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_Statistics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) Position(ctx context.Context, in *BatteryPositionRequest, opts ...grpc.CallOption) (*BatteryPositionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Battery_Position_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) List(ctx context.Context, in *BatteryListRequest, opts ...grpc.CallOption) (*BatteryListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatteryListResponse)
	err := c.cc.Invoke(ctx, Battery_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batteryClient) Overlapping(ctx context.Context, in *OverlappingRequest, opts ...grpc.CallOption) (*OverlappingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OverlappingResponse)
	err := c.cc.Invoke(ctx, Battery_Overlapping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BatteryServer interface {
	...
	List(context.Context, *BatteryListRequest) (*BatteryListResponse, error)
	Overlapping(context.Context, *OverlappingRequest) (*OverlappingResponse, error)
	mustEmbedUnimplementedBatteryServer()
}

// UnimplementedBatteryServer must be embedded to have
...
func (UnimplementedBatteryServer) List(context.Context, *BatteryListRequest) (*BatteryListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedBatteryServer) Overlapping(context.Context, *OverlappingRequest) (*OverlappingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Overlapping not implemented")
}
...
func RegisterBatteryServer(s grpc.ServiceRegistrar, srv BatteryServer) {
	// If the following call pancis, it indicates UnimplementedBatteryServer was
...
func _Battery_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatteryListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BatteryServer).List(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Battery_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BatteryServer).List(ctx, req.(*BatteryListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Battery_Overlapping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OverlappingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BatteryServer).Overlapping(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Battery_Overlapping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BatteryServer).Overlapping(ctx, req.(*OverlappingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Battery_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "List",
			Handler:    _Battery_List_Handler,
		},
		{
			MethodName: "Overlapping",
			Handler:    _Battery_Overlapping_Handler,
		},
	},
